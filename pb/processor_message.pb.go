...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: proto.pcbook.CPU
	(*GPU)(nil),    // 1: proto.pcbook.GPU
	(*Memory)(nil), // 2: proto.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: proto.pcbook.GPU.memory:type_name -> proto.pcbook.Memory
